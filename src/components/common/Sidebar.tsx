...
const customerNavigation: SidebarItem[] = [
  ...
  },
  {
    ...
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 3h2l.4 2M7 13h10l4-8H5.4m0 0L7 13m0 0l-2.5 5M7 13l2.5 5m6-5v5a2 2 0 01-2 2H9a2 2 0 01-2-2v-5m6-5V7a3 3 0 00-6 0v1" />
      </svg>
    )
  },
  {
...
const ownerNavigation: SidebarItem[] = [
  {
    name: '대시보드',
    href: '/owner',
    icon: (
...
export const Sidebar: React.FC = () => {
  ...
  const getNavigation = () => {
    switch (user.role) {
      ...
      case 'owner': return ownerNavigation
